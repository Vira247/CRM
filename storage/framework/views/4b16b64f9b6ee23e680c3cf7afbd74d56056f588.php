...
<body class="hold-transition layout-top-nav">
  <div class="wrapper">
    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
      <div class="container">
        <a href="<?php echo e(route('home')); ?>" class="navbar-brand">
          ...
          <span class="brand-text font-weight-light">Villo Home</span>
        </a>
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item dropdown">
              ...
              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                <li><a href="<?php echo e(URL::to('vendor-report-gorup-by-month-year')); ?>" target="_blank" class="dropdown-item">Vendor Report </a></li>
                <li><a href="<?php echo e(URL::to('sample-vs-product')); ?>" target="_blank" class="dropdown-item">Sample VS Product Report (By Vendor)</a></li>
                <li><a href="<?php echo e(URL::to('report/sample-vs-product-summury')); ?>" target="_blank" class="dropdown-item">Sample VS Product Report (By Month)</a></li>
                <li><a href="<?php echo e(URL::to('product-order-by-vendor-date')); ?>" target="_blank" class="dropdown-item">Order Item Report</a></li>
                <?php /*
            ...
            </li>			<li class="nav-item dropdown">              <a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Google Report</a>              <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">                <li><a href="<?php echo e(URL::to('getdata-sessions-pageviews')); ?>" target="_blank" class="dropdown-item">Sessions Pageviews</a></li>                <li><a href="<?php echo e(URL::to('getdata-sessions-pageviews-path')); ?>" target="_blank" class="dropdown-item">Sessions Pageviews Path</a></li>                <li><a href="<?php echo e(URL::to('getdata-mobile-trafic')); ?>" target="_blank" class="dropdown-item">Mobile Trafic</a></li>                <li><a href="<?php echo e(URL::to('getdata-users')); ?>" target="_blank" class="dropdown-item">Users</a></li>                <li><a href="<?php echo e(URL::to('getdata-sessions-by-country')); ?>" target="_blank" class="dropdown-item">Sessions By Country</a></li>                <li><a href="<?php echo e(URL::to('getdata-keywords')); ?>" target="_blank" class="dropdown-item">Keywords</a></li>                <li><a href="<?php echo e(URL::to('getdata-top-landing-pages')); ?>" target="_blank" class="dropdown-item">Top Landing Pages</a></li>                <li><a href="<?php echo e(URL::to('getdata-top-exit-pages')); ?>" target="_blank" class="dropdown-item">Top Exit Pages</a></li>                <li><a href="<?php echo e(URL::to('getdata-session-by-time')); ?>" target="_blank" class="dropdown-item">Session By Time</a></li>              </ul>            </li>
        ...
        <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
          ...
          <li class="nav-item dropdown user-menu">
            ...
            <?php if(auth()->user()->profilepic != ""): ?>
                <img src="<?php echo e(asset(auth()->user()->profilepic)); ?>" alt="User Image" class="user-image img-circle elevation-2">
            <?php else: ?>
              <img src="<?php echo e(asset('dist/img/user2-160x160.jpg')); ?>" alt="User Image" class="user-image img-circle elevation-2">
            <?php endif; ?>
            ...
            <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
              ...
              <?php if(auth()->user()->profilepic != ""): ?>
                <img src="<?php echo e(asset(auth()->user()->profilepic)); ?>" alt="User Image" class="img-circle elevation-2">
              <?php else: ?>
                <img src="<?php echo e(asset('dist/img/user2-160x160.jpg')); ?>" alt="User Image" class="img-circle elevation-2">
              <?php endif; ?>
                <p>
              ...
              <li class="user-footer">
                ...
                <a class="btn btn-default btn-flat float-right" href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault(); document.getElementById('logout-form').submit();">Sign out</a>
    ...
    <!-- /.navbar --><?php /**PATH C:\xamppnew\htdocs\CRM\resources\views/layouts/header.blade.php ENDPATH**/ ?>