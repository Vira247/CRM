...
<div class="content-wrapper">
	...
	<div class="col-md-12">
          ...
          <div class="card card-primary">
			...
			<!-- /.box-header -->
            <!-- form start -->
			<?php echo Form::model($master_detail, ['method' => 'PATCH','route' => ['vendor.update', $master_detail->id],'enctype' => "multipart/form-data"]); ?>
					...
					<div class="row">
                        ...
                        <div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="contact_person_name" id="contact_person_name" class="form-control" value="<?php echo $master_detail->contact_person_name; ?>" placeholder="Contact Person Name">
                        ...
                        <div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="contact_email_address" id="contact_email_address" class="form-control" value="<?php echo $master_detail->contact_email_address; ?>" placeholder="Contact e-mail address">
                        ...
                        <div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="head_office_address" id="head_office_address" class="form-control" value="<?php echo $master_detail->head_office_address; ?>" placeholder="Head Office Address">
                        ...
                        <div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" name="warehouse_address" id="warehouse_address" class="form-control" value="<?php echo $master_detail->warehouse_address; ?>" placeholder="Warehouse Address">
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppnew\htdocs\laravel_demo\resources\views/vendor/edit.blade.php ENDPATH**/ ?>