...
?>
        ...
        <div class="row">
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <img src="<?php echo e(asset($session['profilepic'])); ?>" alt="User Avatar" class="img-size-50 mr-3 img-circle">
              <?php else: ?>
              <img src="<?php echo e(asset('dist/img/user1-128x128.jpg')); ?>" alt="User Avatar" class="img-size-50 mr-3 img-circle">
              <?php endif; ?>
							<form action="<?php echo e(URL::to('upload-profile-pic')); ?>" id="fileform" method="POST" enctype="multipart/form-data">
              <?php echo csrf_field(); ?>
  ...
  <!-- /.content-wrapper -->
  <!-- /.content-wrapper -->
  <?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppnew\htdocs\laravel_demo\resources\views/profile.blade.php ENDPATH**/ ?>