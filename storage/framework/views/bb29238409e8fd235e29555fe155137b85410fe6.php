  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12">
        ...
        <?php $__currentLoopData = $lists; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $name=>$list): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        <?php if(count($list) > 0): ?>
        <div class="card">
          <div class="card-header">
...
<?php echo $__env->make('layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xamppnew\htdocs\laravel_demo\resources\views/product/report-sample-vs-product.blade.php ENDPATH**/ ?>