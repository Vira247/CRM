            ...
            <div class="card">
              ...
              <form method="get" action="" name="searchPrduct" role="form" id="searchPrduct" enctype="multipart/form-data" class="form-horizontal">
                    ...
                    <div class="col-sm-2">
                      <select class="form-control" name="vendors">
                        ...
                        <?php foreach ($vendorList as $vendor) { ?>
                          <option value="<?php echo e($vendor->id); ?>" <?php if ($vendor->id == $vendors) {
                                                            echo "selected";
                ...
                <div class="card-footer clearfix">
                  ...
                  <a target="_blank" href="<?php echo e(URL::to('sample-vs-product-report')); ?>" class="btn btn-success">Sample VS Product</a>
