...
class Order extends Authenticatable{
    ...
    'claim_against','vendor_claim','vendor_claim','shipping_claim','shipping_claim_amount','claim_status','discount','flag','extranote','profit','primary_agent','secondary_agent'];
}