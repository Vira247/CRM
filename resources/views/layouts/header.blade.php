      ...
      <div class="container">
        ...
        <div class="collapse navbar-collapse order-3" id="navbarCollapse">
          ...
          <ul class="navbar-nav">
            ...
            <li class="nav-item">
              <a href="{{ route('users.index') }}" target="_blank" class="nav-link"> Users</a>
            </li>
            @endcanany
            @canany(['role-list', 'role-create','role-edit','role-delete'])
            <li class="nav-item">
              <a href="{{ route('roles.index') }}" target="_blank" class="nav-link"> Roles</a>
            </li>
            @endcanany
            @canany(['master-list', 'master-create','master-edit','master-delete'])
            <li class="nav-item">
              <a href="{{ route('master.index') }}" target="_blank" class="nav-link"> Master</a>
            </li>
            @endcanany
            @canany(['vendor-list', 'vendor-create','vendor-edit','vendor-delete'])
            <li class="nav-item">
              <a href="{{ route('vendor.index') }}" target="_blank" class="nav-link"> Vendor</a>
            </li>
            @endcanany
            @canany(['product-list', 'product-create','product-edit','product-delete'])
            <li class="nav-item">
              <a href="{{ route('product.index') }}" target="_blank" class="nav-link"> Product</a>
            </li>
            @endcanany
			...
			<li class="nav-item dropdown">
			<a id="dropdownSubMenu1" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Google Report</a>
				<ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
					<li><a href="{{URL::to('getdata-sessions-pageviews')}}" target="_blank" class="dropdown-item">Sessions Pageviews</a></li>
					<li><a href="{{URL::to('getdata-sessions-pageviews-path')}}" target="_blank" class="dropdown-item">Sessions Pageviews Path</a></li>
					<li><a href="{{URL::to('getdata-mobile-trafic')}}" target="_blank" class="dropdown-item">Mobile Trafic</a></li>
					<li><a href="{{URL::to('getdata-users')}}" target="_blank" class="dropdown-item">Users</a></li>
					<li><a href="{{URL::to('getdata-sessions-by-country')}}" target="_blank" class="dropdown-item">Sessions By Country</a></li>
					<li><a href="{{URL::to('getdata-keywords')}}" target="_blank" class="dropdown-item">Keywords</a></li>
					<li><a href="{{URL::to('getdata-top-landing-pages')}}" target="_blank" class="dropdown-item">Top Landing Pages</a></li>
					<li><a href="{{URL::to('getdata-top-exit-pages')}}" target="_blank" class="dropdown-item">Top Exit Pages</a></li>
					<li><a href="{{URL::to('getdata-session-by-time')}}" target="_blank" class="dropdown-item">Session By Time</a></li>
				</ul>
			</li>
          ...
          <!-- SEARCH FORM -->
          <?php /*<form class="form-inline ml-0 ml-md-3">
